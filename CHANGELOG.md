...
- UI polish: одна финальная строка на видео вместо отдельных success-строк потоков, подготовка через before_dl, отсутствие двойных status-тегов в TTY.
- Удалены неиспользуемые helpers старого строкового вывода загрузки.
